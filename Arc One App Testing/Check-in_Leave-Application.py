...
def create_leave_application():
    ...
    xpath_select_year = '//android.widget.TextView[@resource-id="android:id/text1" and @text="2030"]'
    xpath_next_month = '//android.widget.ImageButton[@content-desc="Next month"]'
    xpath_from_day = '//android.view.View[@content-desc="21 September 2030"]'
    ...
    xpath_to_day = '//android.view.View[@content-desc="23 September 2030"]'
...
take_screenshot('leave_application08.png')
close_app_via_back()
